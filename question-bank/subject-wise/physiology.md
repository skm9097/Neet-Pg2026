# Physiology — Multi-Year PYQ Pool

> **Source:** PrepLadder last-5-year PYQ compilation.  
> **Use:** Personal study notes. ~16 questions spanning multiple years.

---

### Q1 — High altitude pulmonary oedema: NOT used
...
**A. IV digoxin** — Not part of HAPE/AMS management. Immediate descent is most effective. Oxygen, acetazolamide (prevention), nifedipine (pulmonary vasodilator for HAPE), dexamethasone (for HACE), sildenafil are used.
</details>

---

### Q2 — Highest prolactin level timing
...
**B. 24 hours after delivery** — Prolactin peaks immediately after delivery for milk production. Note: prolactin also has nocturnal surges, peaks during REM sleep, and rises with stress/exercise — but delivery has the highest physiological peak.
</details>
...
The "c" wave in JVP represents:

- A. Tricuspid bulge into RA during isovolumetric ventricular contraction
- B. RA contraction
- C. Passive RA filling
- D. Passive RA emptying

<details><summary>Answer</summary>

**A. Tricuspid bulge into RA during isovolumetric contraction** — JVP waves: a (atrial contraction), c (tricuspid bulge from RV pressure), x (atrial relaxation), v (atrial filling), y (atrial emptying through open tricuspid).
</details>

---

### Q4 — GBM charge-dependent filtration

Which protein in glomerular basement membrane provides charge-selective filtration?
...
**B. Heparan sulfate** — Negatively charged GAG in GBM repels negatively-charged albumin → prevents proteinuria. Loss of heparan sulfate (minimal change disease) → albuminuria.
</details>

---

### Q5 — Vitamin K-dependent factors and γ-carboxyglutamate
...
**A. Factor II (prothrombin)** — Vitamin K-dependent factors (II, VII, IX, X + Proteins C, S) require γ-carboxylation of glutamate residues to bind calcium. Warfarin inhibits Vitamin K epoxide reductase → ↓γ-carboxyglutamate.
</details>

---

### Q6 — Sodium deficit calculation

70 kg male with serum Na 120 mEq/L. Total Na deficit?
...
**C. 840 mEq** — Na deficit = TBW × (target Na − current Na). TBW = 0.6 × 70 = 42 L. Deficit = 42 × (140 − 120) = 840 mEq. Note: replacement must be slow (≤ 8–10 mEq/L per 24 h) to avoid ODS.
</details>

---

### Q7 — Nerve fibre sensitivity (Saturday night palsy)

Paresis without numbness after arm compression during sleep. Which fibre is more affected?

- A. A fibres more sensitive to pressure than C fibres
- B. A fibres more sensitive to hypoxia than B
- C. A fibres more susceptible to pressure than C
- D. A fibres more susceptible to hypoxia than C

<details><summary>Answer</summary>

**C. A fibres more susceptible to pressure than C fibres** — A (myelinated, motor + touch + proprioception) > B > C (unmyelinated, pain + temperature). Pressure preferentially blocks A fibres → motor weakness with preserved pain (Saturday night palsy).
</details>

---

### Q8 — Baroreceptor reflex

Baroreceptor reflex is an example of:
...
**C. Negative feedback** — ↑BP → carotid sinus stretch → ↑afferent firing → medulla → ↓sympathetic + ↑parasympathetic → ↓HR + ↓BP. Classic negative feedback.
</details>

---

### Q9 — Paracrine signalling

Cells signalling neighbouring cells via local diffusion:
...
**A. Paracrine** — Local diffusion to nearby cells (e.g., histamine, prostaglandins, growth factors). Autocrine = cell signals itself. Endocrine = blood-borne distant signalling.
</details>

---

### Q10 — Cystometrogram: Laplace law segment

In a cystometrogram, which segment reflects Laplace's law?

- A. Segment Ia (residual urine)
- B. Segment Ib (Laplace law)
- C. Micturition fails in segment II
- D. Micturition in Ib

<details><summary>Answer</summary>

**B. Segment Ib is due to Laplace law** — Bladder volume increases without pressure rise initially (Ia); slight rise in Ib follows Laplace's law (P = 2T/r). Steep rise in Segment II = stretched detrusor + micturition reflex.
</details>

---

### Q11 — Hypothalamic thermostat reset: changes NOT occurring

Resetting hypothalamic thermostat from A to C (febrile response). Which is NOT triggered?
...
**C. Sweating** — Fever: hypothalamic set-point ↑ → body heat-conserving responses (shivering, vasoconstriction, piloerection, epinephrine release). Sweating occurs when fever breaks (set-point returns to normal).
</details>

---

### Q12 — Myogenic autoregulation

In myogenic autoregulation, afferent arterioles contract in response to:
...
**C. Calcium** — Stretch of arteriolar smooth muscle → opens stretch-activated Ca²⁺ channels → calcium influx → contraction → maintained GFR despite BP changes. Tubuloglomerular feedback uses adenosine.
</details>

---

### Q13 — Decerebrate rigidity: NOT characteristic

Which is NOT a feature of decerebrate rigidity?

- A. Rigidity in all body muscles
- B. Increased γ-efferent discharge
- C. Increased motor neuron excitability
- D. Mid-collicular lesion

<details><summary>Answer</summary>

**A. Rigidity in all body muscles** — Decerebrate rigidity primarily affects antigravity (extensor) muscles, not all muscles. Caused by mid-collicular lesion → unopposed lateral vestibular and reticular drive → extensor rigidity.
</details>

---

### Q14 — Decorticate posturing

Decorticate posturing is characterised by:

- A. Cortex/basal ganglia removal
- B. Lower limb flexion with upper limb extension
- C. Pronounced rigidity
- D. Upper limb flexion with lower limb extension

<details><summary>Answer</summary>

**D. Upper limb flexion with lower limb extension** — Decorticate: flexion of arms, fists clenched, legs extended. Lesion above red nucleus (cerebrum). Decerebrate (all extension): lesion below red nucleus (brainstem). Decerebrate is worse prognosis.
</details>

---

### Q15 — RBC preservation (ACD vs CPDA)

RBC preservation in ACD alone vs ACD + adenine + phosphate:
...
**B. 21 days and 35 days** — ACD (Acid Citrate Dextrose): 21 days. CPDA-1 (Citrate Phosphate Dextrose Adenine): 35 days. SAGM additive: up to 42 days.
</details>

---

### Q16 — Functional residual capacity
...
**C. ERV + RV** — FRC = volume remaining in lungs after normal tidal expiration = ERV + RV ≈ 2400 mL. Cannot be measured by spirometry (helium dilution or body plethysmography needed).
</details>

---
# Physiology — Expansion Batch 1
# To be merged into: subject-wise/physiology.md
# Starting from Q17 (continuing from existing 16 Qs)
# Source: PrepLadder last-5-years PYQ physiology

### Q17 — Altitude sickness / NOT used in management

Which drug is NOT used in acute mountain sickness management?
...
**C. Digoxin** — Altitude sickness management: descent, supplemental O2, acetazolamide (carbonic anhydrase inhibitor → metabolic acidosis → stimulates breathing), dexamethasone (HACE), nifedipine (HAPE). Digoxin is not used.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q18 — Prolactin / Peak secretion timing

Prolactin level is highest at which time point?

- A. At the time of delivery
- B. 24 hours after delivery
- C. 48 hours after delivery
- D. On day 5 postpartum

<details><summary>Answer</summary>

**B. 24 hours after delivery** — Serum prolactin peaks at 24 hours after delivery. During pregnancy, prolactin rises progressively but milk production is suppressed by estrogen/progesterone. Suckling then maintains prolactin levels.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q19 — JVP waveform / c wave

JVP "c" wave represents?

- A. Atrial contraction
- B. Tricuspid valve bulge into RA during isovolumetric ventricular contraction
- C. Passive atrial filling
- D. Atrial relaxation

<details><summary>Answer</summary>

**B. Tricuspid valve closure + bulge into RA** — "a" = atrial contraction; "c" = tricuspid closure + bulge; "x" = atrial relaxation + tricuspid descent; "v" = passive venous filling; "y" = tricuspid opens, RA empties. "c" wave absent in tricuspid regurgitation.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q20 — Renal / Glomerular charge selectivity

Which molecule in the glomerular basement membrane provides charge-selective filtration barrier?
...
**C. Heparan sulfate proteoglycan** — Negatively charged GAG (agrin, perlecan) in GBM repels negatively charged plasma proteins (albumin). Heparan sulfate depletion → proteinuria in diabetic nephropathy.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q21 — Coagulation / Warfarin mechanism

Warfarin decreases gamma-carboxyglutamate (Gla) residues in which coagulation factor?
...
**B. Factor II (prothrombin)** — Warfarin inhibits vitamin K epoxide reductase → impairs gamma-carboxylation of factors II, VII, IX, X, Protein C, Protein S. Factor II (prothrombin) is the key clotting factor affected.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q22 — Nerve / Saturday night palsy — fibres

Saturday night palsy (radial nerve compression) — paresis without numbness due to?

- A. C fibres (pain/temperature) are more resistant to pressure
- B. A-alpha fibres are more susceptible to pressure than C fibres
- C. A fibres (motor/touch) are more susceptible to pressure than C fibres
- D. Autonomic fibres are selectively affected

<details><summary>Answer</summary>

**C. A fibres more susceptible to pressure than C fibres** — Pressure blocks large myelinated A fibres (motor, proprioception, light touch) first; smaller unmyelinated C fibres (pain/temperature) are more resistant. Hence paresis without analgesia.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q23 — Homeostasis / Baroreceptor reflex

Baroreceptor reflex is an example of which type of feedback?

- A. Positive feedback
- B. Negative feedback
- C. Feed-forward control
- D. Anticipatory reflex

<details><summary>Answer</summary>

**B. Negative feedback** — Baroreceptors sense increased BP → reflex bradycardia + vasodilation to restore BP to setpoint. Negative feedback maintains homeostasis. Exception: parturition, LH surge = positive feedback.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q24 — Cell signalling / Paracrine

Cells that signal neighbouring cells through local diffusion of signalling molecules?
...
**C. Paracrine signalling** — Acts on neighbouring cells via local diffusion (short range). Autocrine = same cell as source. Endocrine = distant cells via bloodstream. Juxtacrine = direct cell-to-cell contact.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q25 — Micturition / Cystometrogram

Cystometrogram segment that reflects Laplace's law (tension vs pressure relationship)?

- A. Segment Ia (initial pressure rise)
- B. Segment Ib (flat compliance segment)
- C. Segment II (active filling)
- D. Segment III (voiding contraction)

<details><summary>Answer</summary>

**B. Segment Ib** — Bladder accommodates large volumes with little pressure change (high compliance); Laplace's law: as radius increases, wall tension increases proportionally → pressure stays flat. Segment Ib = high compliance phase.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q26 — Thermoregulation / Fever — what does NOT occur during rise

During fever (rising phase of resetting thermostat) — which does NOT occur?
...
**C. Sweating** — During fever rise: hypothalamic setpoint ↑ → shivering (generate heat), vasoconstriction (conserve heat), piloerection. Sweating occurs when fever breaks (defervescence) as heat is dissipated.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q27 — Renal / Myogenic autoregulation mechanism

In myogenic autoregulation of GFR, afferent arteriole responds to increased pressure by?

- A. Activating ATP-sensitive K+ channels
- B. Opening stretch-activated Ca2+ channels → vasoconstriction
- C. Releasing renin
- D. Activating macula densa sensing

<details><summary>Answer</summary>

**B. Stretch-activated Ca2+ channels → vasoconstriction** — Increased perfusion pressure → stretch of afferent arteriole wall → Ca2+ influx → myosin light chain phosphorylation → vasoconstriction → maintains GFR constant (autoregulation range: MAP 80–180 mmHg).

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q28 — Posture / Decerebrate vs decorticate

Decorticate posturing is characterized by?

- A. Extension of all four limbs
- B. Flexion of upper limbs + extension of lower limbs
- C. Extension of upper limbs + flexion of lower limbs
- D. Flaccid paralysis

<details><summary>Answer</summary>

**B. Flexion of upper limbs + extension of lower limbs** — Decorticate = corticospinal lesion above midbrain → FLEX upper, extend lower (remember: "de-cortic-ate = Flex toward core"). Decerebrate = midbrain/pons lesion → extension of all four limbs (worse prognosis).

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q29 — Blood banking / Preservation duration

RBC preservation duration: ACD vs CPDA-1?

- A. 14 days vs 28 days
- B. 21 days vs 35 days
- C. 28 days vs 42 days
- D. 35 days vs 56 days

<details><summary>Answer</summary>

**B. 21 days (ACD) vs 35 days (CPDA-1)** — ACD (acid citrate dextrose) = 21 days at 4°C. CPDA-1 (citrate phosphate dextrose adenine) = 35 days. Additive solutions (AS-1, AS-3) = 42 days. Storage lesion: ↓2,3-DPG, ↑K+, hemolysis.

</details>

<!-- SOURCE: prepladder.com PYQ physiology | OPTIONS_GENERATED: false -->

### Q30 — Lung volumes / FRC formula

Functional residual capacity (FRC) equals?

- A. TV + IRV (inspiratory reserve)
- B. ERV + RV (expiratory reserve volume + residual volume)
- C. TLC − IRV
- D. IC + ERV

<details><summary>Answer</summary>

**B. ERV + RV** — FRC = volume in lungs at end of normal expiration (passive). FRC = ERV + RV. FRC cannot be measured by spirometry (RV can't be exhaled); measured by helium dilution, nitrogen washout, or body plethysmography.
...
<!-- PDF SOURCE BATCH: Physiology_NEET_PG_PYT_2018_2023 (2018–2023) -->

### Q31 — IGF-1 — producing organ

Predominant organ producing IGF-1 (somatomedin C):
...
**A. Liver** — GH → liver → IGF-1. IGF-1 mediates anabolic effects of GH. Stable levels (vs. pulsatile GH) → better marker of GH status. ↓IGF-1 in dwarfism, malnutrition, liver disease; ↑in acromegaly.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2018 | OPTIONS_GENERATED: false -->
...
**C. Difficulty identifying known faces** — Face blindness; fusiform face area (FFA) in right inferior temporal lobe. Bilateral occipitotemporal lesion. Patient uses voice/gait/clothing to identify people. Distinct from agnosia (object recognition) and prosopamnesia.
...
**C. Sodium outflow in thin ascending limb** — Thin ascending limb: impermeable to water, only passive NaCl diffusion (no active transport). Active Na⁺/K⁺/2Cl⁻ cotransport (NKCC2) = thick ascending limb only. NKCC2 inhibited by furosemide → ↓medullary hyperosmolality → impairs urine concentration.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2018 | OPTIONS_GENERATED: false -->

### Q34 — Intestinal glucose absorption

Glucose absorbed in the intestine by:
...
**D. Secondary active transport** — Apical: SGLT1 (Na⁺-glucose, 2Na:1 glucose); basolateral: GLUT2 (facilitated diffusion). Na⁺ gradient maintained by basolateral Na⁺-K⁺-ATPase (primary active). SGLT2 inhibitors (gliflozins) block renal glucose reabsorption. ORS uses SGLT1 mechanism.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2018 | OPTIONS_GENERATED: false -->

### Q35 — O₂ therapy — NOT useful

Oxygen therapy is NOT useful in:
...
**D. Central respiratory depression** — Central hypoventilation: problem is drive, not O₂ content. Supplemental O₂ may worsen by suppressing peripheral chemoreceptors. Treat with assisted ventilation. In type 2 respiratory failure (COPD exacerbation), titrated O₂ (target SpO₂ 88–92%) to avoid removing hypoxic drive.
...
- A. PO₂ becomes zero
- B. No gas exchange possible
- C. Only CO₂ equilibrates with venous blood
- D. PP of CO₂ and O₂ remain normal

<details><summary>Answer</summary>

**B. No gas exchange possible** — V/Q = ∞: ventilation but no perfusion = dead space. Alveolar gas resembles inspired air. No blood → no exchange. V/Q = 0 = shunt (perfusion, no ventilation). Normal mean V/Q = 0.8. COPD: high V/Q areas; pneumonia/atelectasis: low V/Q areas.
...
'c' wave of JVP occurs during:

- A. Isovolumetric ventricular contraction
- B. Slow filling (end diastole)
- C. End of systole
- D. Start of diastole

<details><summary>Answer</summary>

**A. Isovolumetric ventricular contraction** — c wave = tricuspid valve bulging into RA + transmitted carotid pulsation. JVP waveform mnemonic: "a c xv y" — a=atrial contraction; c=closure tricuspid; x=atrial relaxation; v=venous filling; y=valve opens. Giant v wave = TR; absent a = AF; cannon a = AV dissociation.
...
Regarding endothelin-1, all TRUE except:
...
**A. Bronchodilation** — ET-1 causes bronchoconstriction (not bronchodilation). Potent vasoconstrictor (ETA + ETB on smooth muscle). Also: ↓GFR (mesangial contraction), positive inotropy, aldosterone release, mitogenesis. Bosentan (dual ET receptor antagonist) treats PAH. Endothelium-derived: ET-1; vasodilators: NO, prostacyclin.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2018 | OPTIONS_GENERATED: false -->

### Q39 — Aldosterone — maximal stimulus
...
**A. Hyperkalemia** — Hierarchy: hyperkalemia ≈ Ang II > ACTH > hyponatremia. Hyperkalemia directly depolarizes zona glomerulosa → Ca²⁺ influx → aldosterone synthesis. Hypernatremia → ↓renin → ↓Ang II → ↓aldosterone. ACTH = minor permissive role. Conn syndrome = primary hyperaldosteronism (adrenal adenoma).
...
**D. Nitric oxide** — NO → soluble guanylyl cyclase → ↑cGMP → PKG → vascular relaxation. ANP/BNP → particulate GC → ↑cGMP → vasodilation + natriuresis. Sildenafil inhibits PDE5 (cGMP degradation) → sustained erection. Somatostatin → ↓cAMP. AngII, ADH V1 → IP3/DAG.
...
Fe²⁺ transporter at the enterocyte apical membrane:
...
**C. DMT1** — Iron pathway: Fe³⁺ → Fe²⁺ (dcytb); Fe²⁺ enters via DMT1 (apical); exits via ferroportin 1 (basolateral); oxidized by hephaestin → binds transferrin. Hepcidin (liver) inhibits ferroportin → iron trapping in enterocytes + macrophages → anemia of chronic disease.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2018 | OPTIONS_GENERATED: false -->

### Q42 — Cuthbertson trauma response — false

False regarding Cuthbertson's metabolic ebb and flow:

- A. Ebb phase: ↓body temp, ↓O₂ consumption
- B. Flow phase occurs after resuscitation
- C. Ebb phase aims to reduce energy depletion
- D. Ebb phase leads to innate immune activation

<details><summary>Answer</summary>

**D. Ebb phase leads to innate immune activation** — Innate immune activation, hepatic acute-phase response occur in **flow phase**. Ebb phase (early, protective): ↓temp, ↓O₂ consumption, ↓cardiac output. Flow phase (catabolic hypermetabolic): ↑catecholamines, ↑cortisol, ↑cytokines, muscle wasting, ↑gluconeogenesis.
...
**B. Increasing afferent arteriolar resistance** — Shock → sympathetic → renal vasoconstriction (afferent + efferent) → ↓RPF → oliguria. Prolonged → ATN. Kidneys prioritized away from vital organs (brain, heart). Fractional excretion of Na < 1% (pre-renal) vs >2% (intrinsic renal) distinguishes causes.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2018 | OPTIONS_GENERATED: false -->

### Q44 — Myogenic autoregulation — mechanism

Afferent arterioles contract in response to stretch (myogenic hypothesis) via:

- A. Nitric oxide
- B. Noradrenaline
- C. Opening of Ca²⁺ channels
- D. Adenosine

<details><summary>Answer</summary>

**C. Opening of Ca²⁺ channels** — ↑Perfusion pressure → vessel wall stretch → stretch-activated Ca²⁺ channels (TRPC/TRPM) open → Ca²⁺ influx → smooth muscle contraction → vasoconstriction. Maintains GFR constant between MAP 80–180 mmHg. Works alongside TGF for autoregulation.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q45 — Decerebrate rigidity — exception
...
**A. Rigidity in all muscles of the body** — Decerebrate rigidity: **extensor** muscles predominantly affected (all four limbs + neck extensors = opisthotonos); flexors inhibited. Mechanism: loss of corticospinal + rubrospinal inhibition → unrestrained vestibulospinal excitation of extensors. No spinal shock (brainstem reflexes intact).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q46 — Decorticate posturing — true statement

True for decorticate rigidity:

- A. Produced by removal of cortex and basal ganglia only
- B. Flexion of lower limbs + extension of upper limbs
- C. More pronounced than decerebrate
- D. Flexion of upper limbs + extension of lower limbs

<details><summary>Answer</summary>

**D. Flexion of upper limbs + extension of lower limbs** — Corticospinal lesion above midbrain → rubrospinal tract intact → active upper limb flexion; lower limbs extend via vestibulospinal. Mnemonic: de-**cortic**-ate = flex toward **core** (upper limbs). Decerebrate = all four extended = worse brainstem/midbrain lesion.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q47 — Blood storage — ACD vs CPDA-1 duration

ACD preserves RBCs 21 days. Duration with phosphate alone vs. CPDA-1:
...
**B. 21 and 35 days** — ACD + phosphate = 21 days; CPDA-1 = 35 days; additive solutions (AS-1/Adsol) = 42 days. Storage lesion: ↓2,3-DPG (O₂ affinity ↑, delivery ↓), ↑K⁺, ↓ATP, ↑free Hb. CPDA-1 superior: adenine maintains ATP; less 2,3-DPG depletion.
...
**C. ERV + RV** — FRC: ERV + RV ≈ 2.3 L. Unmeasurable by spirometry (RV component). Methods: He dilution, N₂ washout, body plethysmography (most accurate, includes non-communicating trapped gas). ↑FRC: COPD, emphysema (barrel chest, increased AP diameter).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q49 — Medial lemniscus lesion at pons

Medial lemniscus lesion at pons causes:

- A. Pain/temp loss, same side
- B. Pain/temp loss, opposite side
- C. Fine touch/proprioception loss, same side
- D. Fine touch/proprioception loss, opposite side

<details><summary>Answer</summary>

**D. Fine touch/proprioception loss, opposite side** — Medial lemniscus = second-order dorsal column neurons that have already crossed at medulla. Pontine lesion → contralateral loss of fine touch + proprioception + vibration. Medial medullary syndrome = same deficit (contralateral) + ipsilateral CN XII palsy + contralateral motor.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q50 — Peristaltic reflex — anterograde relaxation
...
**A. VIP** — Peristaltic reflex: ascending (oral) contraction = ACh + Substance P; descending (anal) relaxation = VIP + NO (nitric oxide). Initiated by 5-HT (serotonin) from enterochromaffin cells. VIP relaxes circular smooth muscle. This is the "law of the intestine" (Bayliss & Starling, 1899).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q51 — Bainbridge reflex — result
...
**D. Bainbridge reflex** — Atrial volume receptors (type B) → vagal afferents → medulla → ↑HR (reflex tachycardia) + ↑contractility. Prevents blood from backing up into pulmonary circulation. Bezold-Jarisch = ventricular chemoreceptors → paradoxical bradycardia + hypotension (vasovagal). Cushing = ↑ICP → bradycardia.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q52 — Testosterone — source

Testosterone production mainly from:
...
**A. Leydig cells** — Leydig (interstitial) cells: LH-stimulated → testosterone synthesis (cholesterol → pregnenolone → testosterone via StAR). Sertoli cells: FSH-stimulated → ABP, inhibin, activin, MIF (anti-Müllerian hormone). Testosterone converted to DHT (5α-reductase) or estradiol (aromatase) in peripheral tissues.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q53 — Tubuloglomerular feedback

Tubuloglomerular feedback primarily functions to:
...
**A. Regulate GFR** — TGF: macula densa (NaCl-sensing) → adenosine + ATP → afferent arteriole constriction → ↓GFR when tubular NaCl ↑. Acts alongside myogenic reflex → together maintain GFR within 10% despite ±50 mmHg MAP variation. Blocked by adenosine antagonists.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q54 — Forced expiration neurons

Which neurons fire predominantly during forceful expiration?
...
**B. Ventral respiratory group** — VRG (nucleus ambiguus + retroambiguus): drives active expiration (internal intercostals + abdominal muscles). Silent during quiet breathing. DRG = quiet inspiration. Pneumotaxic center (parabrachial nucleus) = limits inspiration duration, increases RR. Apneustic center = sustains inspiration.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q55 — ADH — aquaporin channel
...
**B. AQP-2** — ADH (V2 receptor, Gs → cAMP → PKA) → phosphorylates AQP-2 → vesicle fusion with luminal membrane of collecting duct principal cells → ↑water reabsorption. AQP-3/4 = constitutive basolateral. AQP-1 = PCT + descending thin limb (ADH-independent). Nephrogenic DI = AQP-2 or V2R mutation.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q56 — Slowest conduction velocity nerve fiber

Slowest conduction velocity:

- A. Postganglionic sympathetic (C fibers)
- B. Somatic motor (Aα)
- C. Preganglionic autonomic (B)
- D. Touch/pressure fibers (Aβ)

<details><summary>Answer</summary>

**A. Postganglionic sympathetic (C fibers)** — Velocities: Aα = 70–120; Aβ = 30–70; Aγ = 15–30; Aδ = 5–30; B = 3–15; C = 0.3–1.3 m/s (slowest, unmyelinated). C fibers carry: pain (slow), temperature, itch, postganglionic autonomic. B fibers (lightly myelinated) = preganglionic.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q57 — Vitamin A — hepatic storage cell

Which cell stores vitamin A in the liver?

- A. Ito (stellate) cells
- B. Hepatocytes
- C. Endothelial cells
- D. Kupffer cells
...
**A. Ito (hepatic stellate) cells** — Perisinusoidal stellate (Ito) cells: store 80% body vitamin A as retinyl palmitate lipid droplets. Activation (by TGF-β in liver injury) → transdifferentiate to myofibroblasts → collagen production → fibrosis. Kupffer = liver macrophages. Hepatocytes = metabolism.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q58 — Liver — NOT synthesized
...
**D. Immunoglobulins** — Immunoglobulins produced by plasma cells (B lymphocyte derivatives). Liver synthesizes: albumin (oncotic pressure), all coagulation factors except Ca²⁺ and vWF (partly) + platelet-derived, acute phase proteins (CRP, fibrinogen, haptoglobin, α1-antitrypsin), complement factors, transport proteins.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q59 — Peripheral chemoreceptors — ion

Ion primarily involved in peripheral O₂-sensing:
...
**A. Potassium** — Glomus cells: hypoxia → inhibition of background K⁺ channels (TASK, BKCa) → depolarization → voltage-gated Ca²⁺ entry → neurotransmitter release (dopamine, ACh) → carotid sinus nerve (CN IX) → medullary respiratory centers. Carotid body also responds to ↑CO₂ and ↓pH.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q60 — Brown-Séquard — deficit pattern

Brown-Séquard syndrome is characterized by:

- A. Fine touch lost contralaterally
- B. Pain/temp lost ipsilaterally
- C. Pain/temp lost contralaterally
- D. Only pain lost ipsilaterally

<details><summary>Answer</summary>

**C. Pain/temp lost contralaterally** — Cord hemisection: ipsilateral = UMN signs + dorsal column loss (fine touch, proprioception, vibration); contralateral = spinothalamic loss (pain, temperature) 1–2 levels below (crosses before ascending). Mnemonic: pain crosses → lost opposite side.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q61 — AMS treatment — NOT used

Which is NOT used in acute mountain sickness:
...
**A. IV digoxin** — AMS management: descent (definitive), O₂, acetazolamide (CAi → metabolic acidosis → ↑RR → acclimatization), dexamethasone (HACE), nifedipine (HAPE). Portable hyperbaric chamber (Gamow bag). Digoxin has no role in altitude illness.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q62 — Prolactin — peak timing

Prolactin level is highest:

- A. 24 hours after ovulation
- B. 24 hours after delivery
- C. During REM sleep
- D. After 1 hour of running

<details><summary>Answer</summary>

**B. 24 hours after delivery** — Prolactin peaks at 24 h postpartum. During pregnancy: ↑prolactin but lactation suppressed by ↑estrogen/progesterone. After delivery: estrogen ↓ → lactation begins. Suckling → ↑prolactin (via ↓dopamine) + oxytocin (milk ejection reflex). Dopamine agonists (bromocriptine) suppress prolactin.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q63 — GBM charge filtration — molecule

GBM protein responsible for charge-selective filtration barrier:
...
**B. Heparan sulfate** — Negatively charged GAG (agrin/perlecan → heparan sulfate chains) repels anionic plasma proteins (albumin pI ~4.7). Charge barrier disrupted in minimal change disease (podocyte effacement) and diabetic nephropathy (heparan sulfate depletion) → selective proteinuria → heavy proteinuria.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q64 — Warfarin — Gla residues

Warfarin decreases γ-carboxyglutamate residues in which clotting factor?
...
**A. Factor II (prothrombin)** — Warfarin → ↓vitamin K epoxide reductase → ↓reduced vitamin K → ↓γ-carboxylation of Gla residues → dysfunctional factors II, VII, IX, X + protein C, S. Factor II is key final common pathway protein. PT/INR monitors factors II, VII, X.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q65 — Cushing's disease — hormone levels

Highest ACTH and cortisol seen in:

- A. Early morning physiological state
- B. After low-dose dexamethasone
- C. Addison's disease
- D. Cushing's disease (pituitary)

<details><summary>Answer</summary>

**D. Cushing's disease** — Pituitary ACTH adenoma → ↑↑ACTH → bilateral adrenal hyperplasia → ↑↑cortisol. Ectopic ACTH (SCLC) may have even higher ACTH. Addison's: ↑ACTH, ↓cortisol (adrenal failure). Cushing's suppresses on high-dose (but not low-dose) dexamethasone. Ectopic ACTH: no suppression with either dose.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q66 — Ileal resection — deficiency

After terminal ileal resection, most likely deficiency:
...
**B. Vitamin B12** — IF-bound B12 absorbed exclusively at terminal ileum (cubilin receptors). Folate absorbed in upper jejunum (spared). Ileal resection → B12 deficiency → megaloblastic anemia + subacute combined degeneration of spinal cord (posterior + lateral columns). Also: fat malabsorption (bile salt resection) + diarrhea.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q67 — Type II pneumocyte — RDS

RDS due to defective:

- A. Type I pneumocytes
- B. Type II pneumocytes
- C. Alveolar capillary endothelium
- D. Bronchial mucosal cells

<details><summary>Answer</summary>

**B. Type II pneumocytes** — Type II: cuboidal cells at alveolar corners; produce surfactant (lamellar bodies → surface film). Deficiency (preterm <34 weeks) → ↑surface tension → alveolar collapse → IRDS. Betamethasone antenatally accelerates Type II maturation. L:S ratio ≥2 = lung maturity.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q68 — Receptor tyrosine kinase — hormone

Which hormone uses RTK signalling?
...
**A. Insulin** — RTK ligands: insulin, IGF-1, EGF, PDGF, FGF, VEGF, NGF. Autophosphorylation → IRS-1 → PI3K/Akt (glucose uptake) + MAPK/ERK (proliferation). TSH = Gs (cAMP). TRH = Gq (IP3/DAG). MSH = Gs (MC1R, pigmentation). GH = JAK-STAT pathway (non-RTK).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q69 — Enterogastric reflex

Gastric emptying delayed when acid enters duodenum via:
...
**D. Enterogastric reflex** — Duodenal stimuli (acid, fat, osmolality, distension) → neural (myenteric plexus + vagal) + hormonal (CCK, secretin, GIP) → ↓antral contractions + ↓pyloric relaxation → ↓gastric emptying. Protects duodenum from acid overload. GIP also stimulates insulin ("incretin effect").

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q70 — A fibers — pressure susceptibility

Sleeping with arm under head → paresis but pain preserved. Explanation:

- A. C > A fiber pressure susceptibility
- B. A > B fiber hypoxia susceptibility
- C. A fiber more susceptible to pressure than C
- D. A fiber more susceptible to hypoxia than C

<details><summary>Answer</summary>

**C. A fibers more susceptible to pressure than C fibers** — Large myelinated A fibers (motor Aα, touch Aβ) blocked by compression (neuropraxia) → motor loss + fine touch loss. C fibers (unmyelinated, pain/temperature) resist pressure → pain preserved. Clinical examples: Saturday night palsy (radial nerve), crossed-leg peroneal palsy.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q71 — Fetal circulation — highest O₂

Highest oxygen concentration in fetal circulation:
...
**A. Inferior vena cava** — Umbilical vein (~80% sat) → ductus venosus → IVC (mixes, ~70% sat = highest central). Crista dividens directs IVC blood preferentially through foramen ovale → LA → LV → ascending aorta (brain + coronaries). SVC (low O₂) + IVC residual → RA → RV → pulmonary artery → ductus arteriosus (bypasses lungs).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q72 — Surfactant — main lipid
...
**A. Dipalmitoyl phosphatidylcholine (DPPC)** — DPPC (lecithin) = 60–70% of surfactant. L:S ratio ≥2 = fetal lung maturity (>36 weeks). SP-B most critical protein for surfactant function. SP-A, SP-D = innate immunity. Betamethasone → ↑SP-B/C + DPPC synthesis. Exogenous surfactant: beractant (bovine), poractant (porcine).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q73 — CPDA-1 vs ACD — advantage

CPDA-1 is superior to ACD because:

- A. Less fall in 2,3-DPG
...
**A. Less fall in 2,3-DPG** — Adenine in CPDA-1 maintains ATP synthesis → red cell metabolism preserved → 2,3-DPG maintained longer → O₂ delivery capacity better. Storage lesion (ACD worse): ↓2,3-DPG, ↑K⁺, ↓pH, echinocytes, ↑free Hb. 2,3-DPG ↓ → left shift Hb-O₂ curve → ↑O₂ affinity → ↓tissue O₂ delivery.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q74 — Sodium deficit — calculation

70 kg man, serum Na⁺ = 120 mEq/L. Sodium deficit:
...
**C. 840 mEq** — Na deficit = TBW × (target Na − actual Na) = (0.6 × 70) × (140 − 120) = 42 × 20 = 840 mEq. Replace slowly: ≤10–12 mEq/L/day to prevent osmotic demyelination (central pontine myelinolysis). TBW = 0.6 × BW (male), 0.5 (female), 0.45 (elderly female).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2021 | OPTIONS_GENERATED: false -->
...
**A. Adenylyl cyclase** — β2 → Gs → adenylyl cyclase → ↑cAMP → PKA → glycogenolysis + gluconeogenesis (hyperglycemia); also lipolysis, muscle tremor, hypokalemia (↑Na-K-ATPase). Salbutamol (β2 agonist) → hyperglycemia in diabetics. β1 = cardiac (Gs). α1 = Gq (IP3). α2 = Gi (↓cAMP).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2021 | OPTIONS_GENERATED: false -->

### Q76 — ICF vs ECF electrolytes

Fluid: Na⁺ 10, K⁺ 140, Cl⁻ 4 mEq/L. Compartment?
...
**B. Intracellular fluid** — ICF: K⁺ ~140, Mg²⁺ ~35, PO₄³⁻ ~107; Na⁺ ~10–15, Cl⁻ ~4. ECF (plasma + ISF): Na⁺ ~140, Cl⁻ ~104, HCO₃⁻ ~24. Na⁺-K⁺-ATPase creates these gradients. ICF volume ≈ 28 L (40% BW); ECF ≈ 14 L (20% BW).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2021 | OPTIONS_GENERATED: false -->

### Q77 — MS — cell type affected

In MS, which cell type is primarily destroyed?
...
**B. Oligodendrocytes** — MS = T-cell mediated autoimmune demyelination of CNS. Oligodendrocytes (each myelinates up to 50 axons) are the target. Schwann cells = PNS (Guillain-Barré). MRI: periventricular plaques (Dawson's fingers); CSF: oligoclonal IgG bands, ↑myelin basic protein; VEP: delayed P100.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2021 | OPTIONS_GENERATED: false -->

### Q78 — ORS — transporter exploited

ORS facilitates glucose absorption via:
...
**A. SGLT1** — SGLT1 (SLC5A1): co-transports 2 Na⁺ + 1 glucose. Na⁺ gradient (basolateral Na⁺-K⁺-ATPase) drives glucose uptake. Each glucose brings Na⁺ + osmotic water → net rehydration. WHO ORS composition: 75 mEq Na⁺, 75 mmol glucose, 20 mEq K⁺, 10 mmol citrate. SGLT2 = kidney PCT (gliflozin target).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2021 | OPTIONS_GENERATED: false -->

### Q79 — Pressure block — paresis without pain (2022 version)

Wakes with paresis but no numbness after sleeping on arm. Best explanation:

- A. C > A fiber pressure sensitivity
- B. A > B fiber hypoxia sensitivity
- C. A fibers more susceptible to pressure than C
- D. A > C fiber hypoxia susceptibility

<details><summary>Answer</summary>

**C. A fibers more susceptible to pressure than C fibers** — Restatement of core concept: large myelinated Aα (motor) + Aβ (fine touch) blocked first by pressure → motor loss (paresis) + touch loss; unmyelinated C (pain) resistant → pain preserved. Basis of neuropraxia. Also explains why analgesia (C-fiber sparing) doesn't accompany all motor nerve injuries.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2022 | OPTIONS_GENERATED: false -->

### Q80 — Baroreceptor reflex — feedback type
...
**C. Negative feedback** — ↑BP → carotid sinus + aortic arch baroreceptors → ↑glossopharyngeal/vagal afferents → NTS → ↓sympathetic + ↑parasympathetic → ↓HR + vasodilation → ↓BP. Classic servo-control. Positive feedback (rare): LH surge, coagulation cascade, parturition.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2022 | OPTIONS_GENERATED: false -->

### Q81 — Paracrine signalling

Signal released by one cell → acts on nearby cells by local diffusion. Type:
...
**A. Paracrine** — Short-range local signalling via diffusion. Examples: NO (endothelium → smooth muscle), histamine (mast cells → local vasodilation), prostaglandins, growth factors at wound site. Autocrine = same cell. Endocrine = bloodstream. Juxtacrine = gap junctions or membrane-bound ligand-receptor.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2022 | OPTIONS_GENERATED: false -->

### Q82 — Cystometrogram — Laplace's law

True about the cystometrogram:

- A. Segment Ia = residual urine
- B. Segment Ib = Laplace's law
- C. No micturition in segment II
- D. Dotted line = micturition occurred

<details><summary>Answer</summary>

**B. Segment Ib = Laplace's law** — Bladder compliance: as volume ↑, radius ↑, wall tension ↑, but intravesical pressure stays flat (Laplace: P = 2T/r; tension rises, radius rises, pressure unchanged). Allows large volumes (300–500 mL) with little pressure rise. First sensation of filling = ~150 mL; strong urge = ~400–500 mL.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2022 | OPTIONS_GENERATED: false -->

### Q83 — Fever rising phase — NOT present

Hypothalamic setpoint raised. Which does NOT occur during rising phase?
...
**B. Sweating** — Rising phase: shivering (generate heat), vasoconstriction (conserve heat), piloerection, ↑metabolic rate → raise body temp to new setpoint. Sweating = heat dissipation = occurs only during defervescence (setpoint returns to normal). Antipyretics (paracetamol, aspirin) lower setpoint → sweating → fever breaks.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2022 | OPTIONS_GENERATED: false -->

### Q84 — Hemiballismus — nucleus

Violent proximal limb flinging movements after stroke = lesion in:
...
**A. Subthalamic nucleus** — Hemiballismus: contralateral STN lesion. STN (indirect pathway) normally inhibits GPi → loss → ↓GPi inhibition of thalamus → ↑thalamic output → excessive motor activity. Violent, proximal, flinging, involuntary. Most common cause: small vessel stroke (lacunar infarct). Rx: tetrabenazine, haloperidol.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2022 | OPTIONS_GENERATED: false -->

### Q85 — FRC — spirometry identification

Volume remaining after a normal expiration (FRC) on spirometry:
...
**A. Functional residual capacity** — FRC = ERV + RV ≈ 2.3 L. RV = air that cannot be expelled = FRC not measurable by spirometry alone. Measured by: He dilution (measures communicating air spaces), N₂ washout, body plethysmography (includes trapped gas = most accurate in COPD).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q86 — Heatstroke — absent feature

Heatstroke (T > 40.5°C, collapsed, ↓skin turgor): which is NOT seen?
...
**C. Sweating** — Classic (non-exertional) heatstroke: thermoregulatory failure → **anhidrosis** (no sweating). Hot, dry, red skin; hyperthermia; altered consciousness; multi-organ dysfunction. Exertional heatstroke (athletes) = may have sweating. Distinguish from heat exhaustion (T <40°C, consciousness preserved, sweating present).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q87 — Facilitated diffusion — carrier, no energy

Carrier-mediated transport, no energy requirement =
...
**B. Facilitated diffusion** — Carrier/channel protein + concentration gradient; no ATP. Examples: GLUTs (glucose into RBCs, hepatocytes), urea channels, ion channels (Na⁺ channels in AP). Distinguished from simple diffusion (no carrier) and active transport (energy required). Rate obeys Michaelis-Menten kinetics (saturable).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q88 — Preterm RDS — surface tension and compliance

Preterm baby (28 weeks) develops RDS. Surface tension and compliance?
...
**B. ST ↑, compliance ↓** — Surfactant deficiency → ↑surface tension (alveoli collapse on expiration) → ↓lung compliance (stiffer, more work to inflate). Severe: ground-glass opacity on CXR + air bronchograms. Treatment: exogenous surfactant (intratracheal), CPAP/IPPV, O₂. Corticosteroids (betamethasone) given to mother if <34 weeks.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q89 — Hyperkalemia — membrane potential
...
**C. More positive (depolarization)** — RMP determined by K⁺ gradient (Nernst: EK = −61 log [K+]i/[K+]o). Hyperkalemia → ↓transmembrane K⁺ ratio → EK less negative → RMP depolarizes. Initially: ↑excitability (muscle weakness → cramps); then: Na⁺ channel inactivation → paralysis, cardiac arrhythmia. ECG sequence: peaked T → flat P → wide QRS → sine wave.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q90 — Fasciculus cuneatus — cervical lesion

Cervical dorsal column (lateral aspect) injury — finding?

- A. Absent ipsilateral lower limb proprioception
- B. Absent fine motor of fingers
- C. Absent ipsilateral arm proprioception
- D. Absent contralateral lower limb proprioception

<details><summary>Answer</summary>

**C. Absent ipsilateral arm proprioception** — Lateral dorsal column = fasciculus cuneatus (upper limb, T1 and above). Fasciculus gracilis (medial) = lower limb. Dorsal columns are ipsilateral (decussate at medulla). Cervical lateral dorsal column injury = ipsilateral loss of arm proprioception, vibration, fine touch. Posterior cord syndrome = bilateral dorsal column involvement.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q91 — Cardiac plateau phase — ion channel

Myocardial AP plateau (phase 2) is due to:

- A. Fast Na⁺ channels opening + fast K⁺ closure
- B. Slow prolonged opening of L-type Ca²⁺ channels
- C. Na⁺ closure + slow K⁺ opening
- D. Na⁺/K⁺-ATPase activity

<details><summary>Answer</summary>

**B. Slow prolonged opening of L-type Ca²⁺ channels** — Phase 2 plateau: Ca²⁺ influx (ICaL) balances K⁺ efflux (IKr). Unique to cardiac muscle (not skeletal). Plateau maintains ERP (prevents re-entry/tetany). Ca²⁺ influx triggers CICR from SR (Ca²⁺ sparks → Ca²⁺ transient → contraction). Blocked by Ca²⁺ channel blockers (verapamil, diltiazem).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q92 — Action potential — refractory period
...
**D. Point B–D = refractory period** — B = peak depolarization → absolute refractory period (Na⁺ channels inactivated); C = repolarization → relative refractory (suprathreshold stimulus needed); D = afterhyperpolarization → supernormal period (below normal threshold temporarily). After D → membrane returns to resting (point A).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q93 — Renal clearance substances — graph matching

Renal clearance graph: substance with clearance = 0 at normal plasma levels, then rises = glucose (Tm); substance with clearance = GFR = inulin; substance > GFR = PAH. Correct match:
...
**B. A-Glucose, B-Bicarbonate, C-Inulin, D-PAH** — Glucose clearance: 0 until Tm exceeded (~375 mg/min in plasma); Bicarbonate: mostly reabsorbed at normal pH → clearance < GFR; Inulin: filtered only → clearance = GFR (125 mL/min); PAH: filtered + secreted → clearance = RPF (~620 mL/min) at low plasma concentrations.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q94 — V/Q dead space condition

V/Q = infinity occurs in:

- A. Foreign body obstruction (V/Q = 0)
- B. Dead space ventilation
- C. Equal O₂:CO₂ ratio
- D. Alveolar PO₂ = 159 mmHg, PCO₂ = 40 mmHg

<details><summary>Answer</summary>

**B. Dead space ventilation** — V/Q = ∞: no perfusion → alveolar gas = inspired gas (PO₂ approaches 150 mmHg, PCO₂ → 0). Physiological dead space = anatomical + alveolar dead space. ↑Dead space: pulmonary embolism, COPD (bullae), mechanical ventilation. Measured by Bohr method: VD/VT = (PaCO₂ − PECO₂) / PaCO₂.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q95 — Wernicke's hemianopic pupil — location

Wernicke's hemianopic pupillary reaction — site of lesion:
...
**B. Optic tract** — Pupillary light reflex fibers leave optic tract before LGB → enter superior brachium → pretectal nucleus → Edinger-Westphal. Optic tract lesion: light in blind hemifield → no miosis (Wernicke's sign); light in normal hemifield → normal miosis. Also: contralateral incongruous homonymous hemianopia. LGB lesions: visual field loss, no pupillary defect.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q96 — Broca's area — vascular injury
...
**A. Motor speech area (Broca's)** — Broca's area (BA 44, 45): posterior inferior frontal gyrus, dominant hemisphere. Supplied by superior division of left MCA. Broca's aphasia: telegraphic, non-fluent speech; comprehension intact; patient aware of deficit. Wernicke's = posterior superior temporal gyrus (inferior division MCA).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2020 | OPTIONS_GENERATED: false -->

### Q97 — Blood type O+ — agglutination

No agglutination with anti-A or anti-B; positive with anti-D. Blood group?
...
**C. O positive** — ABO: no A or B antigens = group O. Rh (anti-D positive) = D antigen present = Rh positive. O+ = universal RBC donor for same ABO. O− (no D antigen) = universal donor for emergencies. Bombay phenotype (Oh): lacks H antigen → agglutinates with all ABO groups.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2019 | OPTIONS_GENERATED: false -->

### Q98 — Myocardial action potential phases

Cardiac AP plateau is maintained by:
...
**B. L-type Ca²⁺ influx** — Phase 2 (plateau) = balance of inward ICaL (L-type Ca²⁺) and outward IKr (delayed rectifier K⁺). Unique to cardiac and smooth muscle. Duration ≈ 200–300 ms → ERP prevents tetany. Verapamil/diltiazem → block ICaL → ↓conduction velocity (AV node) + ↓inotropy.

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q99 — Heatstroke vs heat exhaustion

Classic heatstroke vs heat exhaustion: absent feature in heatstroke?
...
**C. Sweating** — Heatstroke: thermoregulatory failure → **no sweating** (anhidrosis), hyperthermia >40.5°C, altered consciousness, hot dry red skin, multi-organ dysfunction. Heat exhaustion: T < 40°C, sweating present, consciousness preserved, treated with rest + hydration. Heatstroke = medical emergency; cool rapidly (ice packs, cooling blanket, cold IV fluids).

</details>

<!-- SOURCE: Physiology_NEET_PG_PYT_2018_2023 2023 | OPTIONS_GENERATED: false -->

### Q100 — Hyperkalemia and RMP

Hyperkalemia → resting membrane potential becomes:

- A. Unchanged
- B. More negative
- C. More positive (depolarized)
- D. First positive then negative

<details><summary>Answer</summary>

**C. More positive (depolarized)** — ↑[K⁺]o → ↓K⁺ gradient → EK (Nernst) less negative → RMP depolarizes closer to threshold → initially ↑excitability. Prolonged → Na⁺ channel inactivation → inexcitability → weakness → paralysis. Cardiac: peaked T waves (early repolarization), flat P, wide QRS, sine wave, VF. Treat: Ca gluconate (stabilizes membrane), insulin+glucose, bicarbonate, dialysis.
...
### Q101 — Occulomotor nerve supplies all extraocular muscles *(2015)*
...
- A. Factor associated with both the exposure and the disease and
- B. Factor associated with exposure only and is distributed
- C. Factor associated with both the exposure and the disease and
- D. Factor associated with the disease and is distributed equally in
...
- C. Failure of gut to return to the body cavity from its physiological
...
- C. Most of the cells in skin are keratinocytes derived from
...
**B. Intracellular fluid** — High K⁺, low Na⁺ — typical ICF profile.
</details>
...
- B. PaO₂ ↓ → pulmonary vasoconstriction → transudation
- C. PaO₂ ↓ → cerebral vasodilation → transudation
- D. pH ↓ → cerebral vasodilation → transudation
...
- B. Prolactin decreases hypothalamic GnRH pulsatility
- C. Prolactin increases FSH secretion
- D. Prolactin increases LH secretion
...
**B. −2 mm Hg** — Starling: Filtration = (Pc − Pi) − σ(πc − πi). 0 = (18 − Pi) − (27 − 7) = (18 − Pi) − 20 → Pi = −2 mm Hg. Negative interstitial pressure promotes lymph drainage.
...
- A. C fibres more sensitive to pressure than A
- B. A fibres more sensitive to hypoxia than B
- C. A fibres more susceptible to pressure than C
- D. A fibres more susceptible to hypoxia than C
...
**C. A fibres more susceptible to pressure than C** — Larger fibres are more pressure-sensitive; smaller (pain/temp C) are more anoxia-sensitive (Saturday night palsy).
</details>
...
**A. Subthalamic nuclei** — Contralateral STN lesion → hemiballismus.
</details>
...
- A. Segment la is due to residual urine
- B. Segment lb is due to Laplace law
- C. Micturition fails to happen in segment ll
- D. The dotted line represents that micturition has occurred
...
**C. Sweating** — Classic heatstroke = anhidrosis (failure of thermoregulation). Skin is hot and dry.
</details>
...
- A. Surface tension ↓ ; Compliance ↑
- B. Surface tension ↑ ; Compliance ↓
- C. Both decreased
- D. Both increased

<details><summary>Answer</summary>

**B. Surface tension ↑, Compliance ↓** — Surfactant deficiency → high alveolar surface tension → stiff lungs.
</details>
...
- A. A-Glucose, B-PAH, C- Bicarbonate and D - Inulin
- B. A-Glucose, B- Bicarbonate, C-Inulin and D - PAH
- C. A-PAH, B-Inulin, C - Glucose and D - Bicarbonate
- D. A - Inulin, B - Glucose, C - Bicarbonate and D - PAH
...
- A. The threshold point is at A
- B. At point E, the nerve is more excitable
- C. Point C to D is due to the opening of Na+ and closure of K+ channels
- D. Point B to D is a refractory period
...
- A. Surface tension - decreased; Compliance - increased
- B. Surface tension - increased; Compliance - decreased
- C. Both surface tension and compliance decreased
- D. Both surface tension and compliance increased
...
- A. Due to the opening of Na+ and closure of fast K+ channels
- B. Due to the slow but prolonged opening of Ca2+ channels
- C. Due to the closure of Na+ and opening of the slow K+ channel
- D. Due to Na+/K+ ATPase er
...
- B. Activates the locus coeruleus and causes wakefulness
- C. No role in maintaining wakefulness if taken 1 hour before sleep
...
**D. D** — Complete obstruction of blood flow (Q=0, V remains) → infinite V/Q ratio. Point D represents pure dead space ventilation (ventilated but not perfused).
</details>
...
**D. −2 mmHg** — Starling equilibrium: Pc − Pi = πc − πi → 18 − Pi = 27 − 7 = 20 → Pi = 18 − 20 = −2 mmHg. Normal interstitial pressure is slightly subatmospheric.
</details>
...
- A. Hypoxia causing vasodilation
- B. Hypoxia causing vasoconstriction
- C. Metabolic acidosis causes oedema
- D. High PO₂ causing vasoconstriction

<details><summary>Answer</summary>

**A. Hypoxia causing vasodilation** — Systemic hypoxia → cerebral vasodilation → increased ICP → headache, nausea. Pulmonary hypoxia causes vasoconstriction (HPV). AMS symptoms are primarily from cerebral oedema.
</details>
...
- A. Rapid rise followed by fall
- B. Gradual rise followed by fall
- C. Remains persistently elevated at same level
- D. Initial rise followed by sustained elevation

<details><summary>Answer</summary>

**D. Initial rise followed by sustained elevation** — First-phase (rapid, 1–3 min): release of pre-formed insulin granules. Second-phase (sustained): new insulin synthesis and secretion. Both phases active with sustained hyperglycemia.
</details>
...
**B. Point B** — Maximum active tension at optimal sarcomere length (~2.2 µm): maximum actin-myosin overlap. At shorter or longer lengths, tension decreases.
</details>
...
**A. Addison's disease** — Primary adrenal insufficiency: low cortisol + low aldosterone → salt craving (aldosterone deficiency → Na wasting), fatigue, muscle weakness, hypotension.
</details>
...
**D. Respiratory alkalosis** — Hypoxia → hyperventilation → CO₂ washout → ↓pCO₂ → respiratory alkalosis. Renal compensation (HCO₃⁻ excretion) occurs over days.
</details>
...
- B. High pulsed LH
- C. High FSH
- D. Inhibition of GnRH by prolactin

<details><summary>Answer</summary>

**D. Inhibition of GnRH by prolactin** — Hyperprolactinemia → inhibits GnRH pulsatility → decreased LH/FSH → anovulation/amenorrhea. Options A and D are essentially the same mechanism; D is more precise.
</details>
