...
- A) $optionA${correctOption == 'A' ? ' ✅' : ''}
- B) $optionB${correctOption == 'B' ? ' ✅' : ''}
- C) $optionC${correctOption == 'C' ? ' ✅' : ''}
- D) $optionD${correctOption == 'D' ? ' ✅' : ''}

## Your Answer

$wrongOption) ${optText(wrongOption)}

## Correct Answer

$correctOption) ${optText(correctOption)}
