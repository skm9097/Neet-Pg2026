...
export interface DesktopApi {
  ...
  // Tray "Sync Now" clicks arrive here (the tray lives in the Rust core).
  onTraySync(cb: () => void): () => void
  // System idle seconds + display keep-awake (Windows; no-ops elsewhere).
